				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=role/datadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="cla_name" class="form-control" placeholder="请输入角色名称  eg:项目经理"/>
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<div class="heckbox checkbox-slider-lg checkbox-slider--b-flat checkbox-slider-danger">
                                                                                            <label>
                                                                                                    <input type="checkbox" name='status' value='1'><span></span>
                                                                                            </label>
                                                                                        </div>
