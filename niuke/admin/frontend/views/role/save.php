				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 角色信息修改
                                                                          <a href='index.php?r=role/role_list' style="color:red;float:right;margin-right: 50px;font-size: 24px;">返回列表</a>
								</small>
							</h1>
						...
						<div class="portlet-body form">
							<form action="index.php?r=role/savedata" id="form-username" class="form-horizontal form-bordered" method='post'>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="r_name" class="form-control" placeholder="请输入课程名称  eg:html5" value="<?echo $rows['r_name']?>"/>
										...
										<div class="input-group">
											...
											<div class="heckbox checkbox-slider-lg checkbox-slider--b-flat checkbox-slider-danger">
                                                                                            <label>
                                                                                                ...
                                                                                                <input type="checkbox" name='status' value='1' <?php if($rows['r_status']==1){?> checked="checked"<?php }?>><span></span>
