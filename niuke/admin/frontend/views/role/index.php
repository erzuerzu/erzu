				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								添加角色
                                                                <a href='index.php?r=role/add' style="color:red;float:right;margin-right: 50px;font-size: 24px;">添加</a>
							</h1>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="#"><?php echo $val['r_name']?></a>
														</td>
														
														
														<td><?php echo $val['time']?></td>

                                                                                                                <td><?php if($val['r_status']==1){ echo "可用";}else{echo "不可用";}?></td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href='#' class="btn btn-xs btn-success">
																	<i class="icon-ok bigger-120"></i>
                                                                                                                            ...
                                                                                                                            <a href='index.php?r=role/xiugai&id=<?php echo $val['_id']?>' class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="index.php?r=role/delete&id=<?php echo $val['_id']?>" class="btn btn-xs btn-danger">
																	<i class="icon-trash bigger-120"></i>
																</a>

																<a  href="index.php?r=role/role_node&id=<?php echo $val['_id']?>" class="btn btn-xs btn-warning">
