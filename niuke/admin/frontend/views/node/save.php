				...
				<div class="main-content">
					...
					<div class="page-content">
							...
							<h1>
								...
								<small>
									 ...
									 更改权限 
                                                                ...
                                                                <a href='index.php?r=node/node_list' style="color:red;float:right;margin-right: 50px;font-size: 24px;">返回列表</a>
							</h1>
						...
						<div class="portlet-body form">
							<form action="index.php?r=node/savedata" id="form-username" class="form-horizontal form-bordered" method='post'>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="n_name" class="form-control"  value="<?echo $rows['n_name']?>"/>
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="nickname" class="form-control" value="<? echo $rows['nickname']?>"/>
									...
									<div class="col-sm-4">
                                                                            <select name='n_level'>
                                                                                ...
                                                                                <option value='1' <?php if($rows['n_level']==1) echo 'selected'?>>1</option>
                                                                                <option value='2' <?php if($rows['n_level']==2) echo 'selected'?>>2</option>
                                                                                <option value='3' <?php if($rows['n_level']==3) echo 'selected'?>>3</option>
                                                                            </select>
									</div>
								</div>
