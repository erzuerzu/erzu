				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=node/datadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="n_name" class="form-control" placeholder="请输入权限名称  列如:goods_class"/>
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="nickname" class="form-control" placeholder="请输入别名  eg:题库管理"/>
									...
									<div class="col-sm-4">
                                                                            <select name='n_level' class='c_level'>
					...
					<!-- END PORTLET-->
                                    ...
                                    <script>
                                        window.onload = function() {
                                            $(".c_level").change(function(){
                                                var id = $(".c_level").val();
                                                    $.ajax({
                                                        type: "GET",
                                                        url: "index.php?r=node/huan",
                                                        dataType:"json",
                                                        data:   "id="+id,
                                                        success: function(obj){
                                                            ...
                                                            var str="";
                                                            str+="<select name='p_id'>";
                                                                $.each(obj,function(i){
                                                                  str+="<option value='"+obj[i]['_id'].$id+"'>"+obj[i]['nickname']+"</option>";
                                                                }); 
                                                            }
                                                            str+="</select>";
