				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								添加权限
                                                                <a href='index.php?r=node/add' style="color:red;float:right;margin-right: 50px;font-size: 24px;">添加</a>
							</h1>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															<a href="#"><?php echo $val['n_name']?></a>
														</td>
														<td>
															<a href="#"><?php echo $val['nickname']?></a>
														</td>
														<td>
															<a href="#"><?php echo $val['n_level']?></a>
														</td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href='#' class="btn btn-xs btn-success">
																	<i class="icon-ok bigger-120"></i>
                                                                                                                            ...
                                                                                                                            <a href='index.php?r=node/xiugai&id=<?php echo $val['_id']?>' class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="index.php?r=node/delete&id=<?php echo $val['_id']?>" class="btn btn-xs btn-danger">
