				...
				<div class="main-content">
					...
					<div class="page-content">
							...
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 用户添加
                                                                ...
                                                                <a href='index.php?r=user/user_list' style="color:red;float:right;margin-right: 50px;font-size: 24px;">返回列表</a>
							</h1>
						...
						<div class="portlet-body form">
							<form action="index.php?r=user/datadd" id="form-username" class="form-horizontal form-bordered" method='post'>
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="user_name" class="form-control" placeholder="请输入用户名称  eg:张三"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="user_email" class="form-control" placeholder="请输入用户邮箱  eg:XXX@163.com"/>
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="password" id="cla_name" name="user_password" class="form-control" placeholder="请输入用户密码"/>
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<div class="heckbox checkbox-slider-lg checkbox-slider--b-flat checkbox-slider-danger">
                                                                                            <label>
                                                                                                    <input type="checkbox" name='user_status' value='1'><span></span>
                                                                                            </label>
                                                                                        </div>
