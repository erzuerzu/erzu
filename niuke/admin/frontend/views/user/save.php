				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=user/savedata" id="form-username" class="form-horizontal form-bordered" method='post'>
                                                            <input type="hidden" name='id' value="<? echo $rows['_id']?>">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="user_name" class="form-control" placeholder="请输入要修改的用户名称" value="<?echo $rows['name']?>"/>
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="user_email" class="form-control" placeholder="请输入修改用户邮箱  eg:XXX@163" value="<?echo $rows['email']?>"/>
