				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								用户列表
								<a href='index.php?r=user/add' style="color:red;float:right;margin-right: 50px;font-size: 24px;">添加</a>
							</h1>
												...
												<tbody>
													...
													<tr>
														...
														<td><?php echo date('Y-m-d H:i:s',$val['addtime']);?></td>
                                                                                                                ...
                                                                                                                <td><?php if(empty($val['status'])){ echo "不可用";}else if($val['status']==1){ echo "可用";}else{echo "不可用";}?></td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href='#' class="btn btn-xs btn-success">
																	<i class="icon-ok bigger-120"></i>
                                                                                                                            ...
                                                                                                                            <a href='index.php?r=user/xiugai&id=<?php echo $val['_id']?>' class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="index.php?r=user/delete&id=<?php echo $val['_id']?>" class="btn btn-xs btn-danger">
																	<i class="icon-trash bigger-120"></i>
																</a>

																<a  href="index.php?r=user/fen_role&id=<?php echo $val['_id']?>" class="btn btn-xs btn-warning">
