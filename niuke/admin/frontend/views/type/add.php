				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=type/doadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								
                                                            <table class="col-md-offset-3 ">
                                                                <tr>
                                                                    <td>分类名称</td>
                                                                    <td><input type="text" id="cla_name" name="type_name" class="form-control" placeholder="请输入分类名称"/></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>是否是父级</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select name="p_id">
                                                                            ...
                                                                            <option value="<?php echo $v['_id']?>"><?php echo $v['type_name']?></option>
                                                                            <?php }?>
                                                                        </select>
                                                                    </td>
                                                                </tr>
