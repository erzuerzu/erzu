				...
				<div class="main-content">
					...
					<div class="page-content">
							...
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 分类添加
                                                    ...
                                                    <a href='index.php?r=class/index' style="float:right;margin-right: 50px;font-size: 24px;">返回列表</a>
						</div><!-- /.page-header -->
						...
						<div class="portlet-body form">
							<form action="index.php?r=type/doedit" id="form-username" class="form-horizontal form-bordered" method='post'>
								
                                                            <table class="col-md-offset-3 ">
                                                                <tr>
                                                                <input type="hidden" name="id" value="<?php echo $rows['_id']?>">
                                                                    <td>分类名称</td>
                                                                    <td><input type="text" id="cla_name" name="type_name" value="<?php echo $rows['type_name']?>" class="form-control" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>是否是父级</td>
                                                                    <td><select name="level">
                                                                            <option>请选择</option>
                                                                            <?php if($rows['level']==1){?>
                                                                            <option value="1" selected>是</option><option value="2" >否</option>
                                                                            <?php }else{?>
                                                                            <option value="1">是</option><option value="2" selected>否</option>
                                                                            <?php }?>
                                                                        </select><span>如果不是父级请选择所属父级</span>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select name="p_id">
                                                                            ...
                                                                            <?php if($rows['level']==2){?>
                                                                            <?php if($vv['_id']==$rows['p_id']){?>
                                                                            <option value="<?php echo $vv['_id']?>" selected><?php echo $vv['type_name']?></option>
                                                                            <?php }?>
                                                                                <option value="0">请选择</option>
                                                                                <option value="<?php echo $vv['_id']?>" ><?php echo $vv['type_name']?></option>
                                                                            <?php }else{?>
                                                                                <option value="0">请选择</option>
                                                                                <option value="<?php echo $vv['_id']?>" ><?php echo $vv['type_name']?></option>
                                                                            <?php }?>
