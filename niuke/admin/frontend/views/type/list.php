					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								...
								<a href='index.php?r=type/add' style="float:right;margin-right: 50px;font-size: 24px;">添加</a>
							</h1>
						</div><!-- /.page-header -->
													...
													<tr>
															...
															<label>
																...
																<span class="lbl"></span>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    ...
                                                                                                                    <a href="index.php?r=type/next&id=<?php echo $v['_id']?>"><?php echo $v['type_name']?></a>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                                                                                            ...
                                                                                                                            <a href="index.php?r=type/edit&id=<?php echo $v['_id']?>" class="btn btn-xs btn-danger">
                                                                                                                                    <i class="icon-edit bigger-120"></i>
																</a>

																<a href="index.php?r=type/del&id=<?php echo $v['_id']?>" class="btn btn-xs btn-danger">
