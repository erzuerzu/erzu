				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=class/secadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								
                                                            <table class="col-md-offset-3 ">
                                                                <tr>
                                                                    <td>章节名称</td>
                                                                    <td><input type="text" id="cla_name" name="z_name" class="form-control" placeholder="请输入课程名称  eg:html5"/></td>
                                                                </tr>
                                                                
                                                                <tr>
                                                                    <td>章节简介</td>
                                                                    <td><textarea style="width:334px;height:93px;" name="z_jieshao" class="form-control" rows="2" placeholder="请输入课程介绍"></textarea></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>属于课程</td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>章节内容</td>
                                                                    <td><textarea style="width:334px;height:93px;" name="z_content" class="form-control" rows="2" placeholder="请输入课程介绍"></textarea></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>章节类型</td>
                                                                   <td>
