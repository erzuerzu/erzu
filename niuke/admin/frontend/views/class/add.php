				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=class/datadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								
                                                            <table class="col-md-offset-3 ">
                                                                <tr>
                                                                    <td>课程名称</td>
                                                                    <td><input type="text" id="cla_name" name="cla_name" class="form-control" placeholder="请输入课程名称  eg:html5"/></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>讲师</td>
                                                                    <td><input type="text" name="teacher" class="form-control" placeholder="请输入课程名称"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>课程简介</td>
                                                                    <td><textarea style="width:334px;height:93px;" name="cha" class="form-control" rows="2" placeholder="请输入课程介绍"></textarea></td>
                                                                </tr>
                                                            </table>
