				...
				<div class="main-content">
					...
					<div class="page-content">
							...
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 精品课堂修改
                                                                 ...
                                                                 <a href='index.php?r=class/index' style="color:red;float:right;margin-right: 50px;font-size: 24px;">返回列表</a>
							</h1>
						...
						<div class="portlet-body form">
							<form action="index.php?r=class/savedata" id="form-username" class="form-horizontal form-bordered" method='post'>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="cla_name" name="cla_name" class="form-control" placeholder="请输入课程名称  eg:html5" value="<?echo $rows['cha_name']?>"/>
										...
										<div class="col-md-9">
											<textarea style="width:334px;height:93px;" name="cha" class="form-control" rows="2" placeholder="请输入课程介绍"><?php echo $rows['cha_introduce']?></textarea>
										</div>
									</div>
