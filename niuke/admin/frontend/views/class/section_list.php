				...
				<div class="main-content">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								章节管理
								 <a href='index.php?r=class/sec_add' style="color:red;float:right;margin-right: 50px;font-size: 24px;">添加</a>
							</h1>
						</div><!-- /.page-header -->
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<td>
															<a href="#"><?php echo $v['z_name']?></a>
														</td>
														<td><?php echo $v['z_introduce']?></td>
                                                                                                                <td class="hidden-480">
                                                                                                                    <?php foreach($data as $vv){ if($v['parent_id']==$vv['_id']){ echo $vv['cha_name'];}}?>
                                                                                                                     
                                                                                                                </td>
														<td><?php if($v['practice_type']==0){
                                                                                                                    echo "视频";
                                                                                                                }else{
                                                                                                                    echo "练习题";
                                                                                                                }
														...
														<td class="hidden-480">
                                                                                                                                <span class="label label-sm label-warning"><?php echo date('Y-m-d H:i:s',$v['update_time'])?></span>
														</td>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href='index.php?r=class/sec_save&id=<?php echo $v['_id']?>' class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href='index.php?r=class/sec_delete&id=<?php echo $v['_id']?>' class="btn btn-xs btn-danger">
