							...
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 直播课程
                                                                ...
                                                                <a href='index.php?r=class/zhiboadd_list' style="color:red;float:right;margin-right: 50px;font-size: 24px;">添加</a>
							</h1>
						</div><!-- /.page-header -->
										...
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tr>
														...
														<td>
															<a href="#"><?php echo $v['b_title'];?></a>
														</td>
														<td><?php echo $v['start_time'];?></td>
														<td class="hidden-480"><?php echo $v['end_time'];?></td>
														<td>
                                                                                                                    <?php foreach($data as $vv){ 
                                                                                                                        if($v['cla_exercise']==$vv['_id']){ 
                                                                                                                            echo $vv['z_name'];
                                                                                                                        }
                                                                                                                        }?>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a  href="index.php?r=class/zhibo_save&id=<?php echo $v['_id']?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="index.php?r=class/zhibo_delete&id=<?php echo $v['_id']?>" class="btn btn-xs btn-danger">
