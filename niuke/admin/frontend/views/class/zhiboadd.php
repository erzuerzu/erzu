				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=class/zhibo_add" id="form-username" class="form-horizontal form-bordered" method='post'>
								
                                                            <table class="col-md-offset-3 ">
                                                                <tr>
                                                                    <td>直播标题</td>
                                                                    <td><input type="text" id="cla_name" name="b_title"  class="form-control" placeholder="请输入直播标题  eg:美团2016笔试真题精讲"/></td>
                                                                </tr>
                                                                
                                                                <tr>
                                                                    <td>开始时间</td>
                                                                    <td><input type="text" id="cla_name" name="start_time" class="form-control" placeholder="请输入直播开始时间"/></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>结束时间</td>
                                                                    <td><input type="text" id="cla_name" name="end_time" class="form-control" placeholder="请输入直播结束时间"/></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>课程回顾</td>
                                                                    <td>
                                                                        <select name="cla_exercise">
                                                                            ...
                                                                            <option value="<?php echo $v['_id']?>"><?php echo $v['z_name']?></option>
                                                                            <?php }?>
                                                                        </select>
                                                                    </td>
                                                                </tr>
