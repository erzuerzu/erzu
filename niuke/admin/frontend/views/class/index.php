							...
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 精品课堂
                                                                ...
                                                                <a href='index.php?r=class/add' style="color:red;float:right;margin-right: 50px;font-size: 24px;">添加</a>
							</h1>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td>
                                                                                                                    <a href="index.php?r=class/section&id=<?php echo $val['_id']?>"><?php echo $val['cha_name']?></a>
														</td>
														<td><?php echo $val['cha_introduce']?></td>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href='#' class="btn btn-xs btn-success">
																	<i class="icon-ok bigger-120"></i>
                                                                                                                            ...
                                                                                                                            <a href='index.php?r=class/xiugai&id=<?php echo $val['_id']?>' class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="index.php?r=class/delete&id=<?php echo $val['_id']?>" class="btn btn-xs btn-danger">
