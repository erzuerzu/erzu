				...
				<div class="main-content">
					...
					<div class="page-content">
							...
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 直播修改
                                                                ...
                                                                <a href='index.php?r=class/zhibo' style="color:red;float:right;margin-right: 50px;font-size: 24px;">返回列表</a>
							</h1>
						</div><!-- /.page-header -->
						...
						<div class="portlet-body form">
							<form action="index.php?r=class/zhiboadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								
                                                            <table class="col-md-offset-3 ">
                                                                <input type="hidden" name="id" value="<?php echo $data['_id'];?>">
                                                                <tr>
                                                                    <td>直播标题</td>
                                                                    <td><input type="text" id="cla_name" name="b_title"  class="form-control" value="<?php echo $data['b_title']?>"/></td>
                                                                </tr>
                                                                
                                                                <tr>
                                                                    <td>开始时间</td>
                                                                    <td><input type="text" id="cla_name" name="start_time" class="form-control" value="<?php echo $data['start_time'];?>" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>结束时间</td>
                                                                    <td><input type="text" id="cla_name" name="end_time" class="form-control" value="<?php echo $data['end_time'];?>"/></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>课程回顾</td>
                                                                    <td>
                                                                        <select name="cla_exercise">
                                                                            <?php foreach($rows as $v){ if($data['cla_exercise']==$v['_id']){?>
                                                                                <option value="<?php echo $v['_id']?>" selected="selected"><?php echo $v['z_name']?></option>
                                                                            <?php }}?>
                                                                        </select>
                                                                    </td>
                                                                </tr>
