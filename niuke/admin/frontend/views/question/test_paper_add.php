				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=question/test_paper_doadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="p_name" name="p_name" class="form-control" placeholder="请输入试卷名称"/>
                                ...
                                <div class="form-group">
									<label class="control-label col-md-3">难度系数：</label>
									<div class="col-md-1">
