				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=question/job_update" id="form-username" class="form-horizontal form-bordered" method='post'>
								<div class="form-group">
									<label class="col-sm-3 control-label">职业名称：</label>
									<div class="col-sm-4">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="fa fa-user"></i>
											</span>
											<input type="text" id="j_name" name="j_name" class="form-control" placeholder="<?php echo $arr['j_name']?>" value="<?php echo $arr['j_name']?>"/>
										
										</div>
									</div>
								</div>
                                
								<input type="hidden" value="<?php echo $arr['_id']?>" name="id">
