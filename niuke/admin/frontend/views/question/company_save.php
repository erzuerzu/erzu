				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=question/company_update" id="form-username" class="form-horizontal form-bordered" method='post'>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="c_name" name="c_name" class="form-control" placeholder="<?php echo $arr['c_name']?>" value="<?php echo $arr['c_name']?>"/>
