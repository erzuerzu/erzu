				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="portlet-body form">
							<form action="index.php?r=question/jod_doadd" id="form-username" class="form-horizontal form-bordered" method='post'>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<div class="input-group">
											...
											<input type="text" id="j_name" name="j_name" class="form-control" placeholder="请输入职位名称"/>
