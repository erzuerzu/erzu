							...
							<h1>
								...
								<i class="icon-double-angle-right"></i>
									 职业列表
                                                    ...
                                                    <a href='index.php?r=class/add' style="float:right;margin-right: 50px;font-size: 24px;">添加</a>
						</div><!-- /.page-header -->
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href='#' class="btn btn-xs btn-success">
                                                                    ...
                                                                    <a href='index.php?r=question/job_save&id=<?php echo $val['_id']?>' class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="index.php?r=question/job_delete&id=<?php echo $val['_id']?>" class="btn btn-xs btn-danger">
